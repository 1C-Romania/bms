...
Function ExternalDataProcessorInfo() Export
	...
	DestinationArray.Add("Document.InventoryWriteOff");

	RegistrationParametrs.Insert("Presentation", DestinationArray);
	
	RegistrationParametrs.Insert("Description", "Forma de listare Bon de consum - casare");
	RegistrationParametrs.Insert("Version", "1.0"); 
	RegistrationParametrs.Insert("SafeMode", False);
	RegistrationParametrs.Insert("Information", "Forma de listare Bon de consum - casare");
...
Function CreatePrintForm(ObjectsArray, PrintObjects, TemplateName)	
	...
	|	InventoryWriteOff.Entity.Prefix 				AS Prefix,
	|	InventoryWriteOff.BaseUnit 						AS WarehousePresentation,
	...
	|		CASE
	|			WHEN (CAST(InventoryWriteOff.Inventory.Nomenclature.DescriptionFull AS STRING(100))) = """"
	|				THEN InventoryWriteOff.Inventory.Nomenclature.Description
	|			ELSE InventoryWriteOff.Inventory.Nomenclature.DescriptionFull
