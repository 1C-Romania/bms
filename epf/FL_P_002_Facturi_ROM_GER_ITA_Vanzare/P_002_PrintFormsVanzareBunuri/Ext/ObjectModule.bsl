...
Function ExternalDataProcessorInfo() Export
	...
	RegistrationParametrs.Insert("Version", "3.5"); 	// "1.0"
	...
	AddCommand(CommandTable,
				"Factura Fiscala Romania",				// what we will see under button PRINT
...
Function CreatePrintForm(ObjectArray, PrintObjects, TemplateName)	
	...
	|	InventoryExpense.DocumentBasis.DocumentBasis.Number AS VST
	|FROM
