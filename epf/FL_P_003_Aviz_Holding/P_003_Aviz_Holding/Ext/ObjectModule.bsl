Function ExternalDataProcessorInfo() Export
	...
	RegistrationParametrs.Insert("Description", "Forma de listare la doc. Vinzare Bunuri- aviz Holding");
	RegistrationParametrs.Insert("Version", "1.0");
	RegistrationParametrs.Insert("SafeMode", False); 
	RegistrationParametrs.Insert("Information", "Forma de listare la doc. Vinzare Bunuri- aviz Holding");
	
	CommandTable = GetCommandTable();
	
	AddCommand(CommandTable,
	"Aviz de expeditie Holding",						  
...
////////////////////////////////Legatura///////////////
		...
		//EndIf ;
			...
			AreaInventory.Parameters["Amount"]    = "0" ;
