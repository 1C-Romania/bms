Function ExternalDataProcessorInfo() Export
	...
	RegistrationParametrs.Insert("Description", "Forma de listare la doc. Vinzare Bunuri- factura Holding");
	RegistrationParametrs.Insert("Version", "1.3");
	RegistrationParametrs.Insert("SafeMode", False); 
	RegistrationParametrs.Insert("Information", "Forma de listare la doc. Vinzare Bunuri- factura Holding");
	
	CommandTable = GetCommandTable();
	
	AddCommand(CommandTable,
	"Factura fiscala Holding",						  
...
Function CreatePrintForm(ObjectArray, PrintObjects, TemplateName)	
    ...
    EndIf;
		...
		If Constants.hiUseEDI.Get() Then
			Header.Parameters.DeliveryAddressTitle = "Punct de lucru";
		...
		While SelectionInventory.Next() Do
			...
			AreaInventory.Parameters["CodBare"]     	= "cod de bare:";
			
//////////////////////////////////Legatura///////////////
AreaInventory.Parameters["Bcode"]    	    = Selection.Barcode;
...
//////////////////////////////////////Legatura//////////////////////////////////////////////////
////////////////////////AreaInventory.Parameters["Bcode"]    	    = Undefined;
/////////////////////////////////////////Legatura///////////////////////////////////////////////
			...
			AreaInventory.Parameters["CodBare"]         = Undefined;
			If TemplateName <>  "FacturaFiscalaStandard" Then
		...
		Footer.Parameters["ClientCode"]  = Selection.Counterparty.Code;
