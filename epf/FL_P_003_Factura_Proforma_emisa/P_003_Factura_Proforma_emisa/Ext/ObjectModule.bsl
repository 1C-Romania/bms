...
Function ExternalDataProcessorInfo() Export
	...
	RegistrationParametrs.Insert("Description", "Forma de listare la doc. Factură proformă");
	RegistrationParametrs.Insert("Version", "1.2"); 	// "1.0"
	RegistrationParametrs.Insert("SafeMode", False); 	// Variants: True, False / Варианты: Истина, Ложь 
	RegistrationParametrs.Insert("Information", "Forma de listare la doc. Factură proformă");
...
Function CreatePrintForm(ObjectsArray, PrintObjects, TemplateName)	
	...
	|	InvoiceForPayment.Author,
	|	InvoiceForPayment.Date,
	|	InvoiceForPayment.Contract,
	|	InvoiceForPayment.Contract.CustomerPaymentTerm,
	|	InvoiceForPayment.DocumentBasis.Number,
	|	InvoiceForPayment.DocumentBasis.Number AS DocumentBasisNumber1,
	|	CustomerOrder.Number AS Number1
	|FROM
	|	Document.InvoiceForPayment AS InvoiceForPayment
	|		LEFT JOIN Document.CustomerOrder AS CustomerOrder
	|		ON InvoiceForPayment.DocumentBasis = CustomerOrder.Ref
	|WHERE
	...
	While Header.Next() Do
		...
		//Template = PrintManagement.GetTemplate("Document.InvoiceForPayment.PF_MXL_" + DesignName);
		...
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////  R
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////  A
		TemplateArea.Parameters.Capital  = Header.Entity.Capital;                                                                   ///////////  R
		TemplateArea.Parameters.Data = Header.Date ;                                                                                ///////////  E
	    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////  S
		...
		TemplateArea.Parameters.AdresaEnt	= InfoAboutEntity.LegalAddress;
		...
		///////////////////////////////////////
		///////////////////////////////////////
		////Rares Paraschiv//////TemplateArea.Parameters.RecipientBankAccountPresentation = InfoAboutEntity.CorrAccount;
		///////////////////////////////////////
		///////////////////////////////////////
...
///////////////////////////////////////////////		
		...
		TemplateArea.Parameters.DataLimita = Format(Header.Date + (Header.Contract.CustomerPaymentTerm * 86400), "DF=""dd.MM.yyyy"""); 
		
		TemplateArea.Parameters.termen     = Header.Contract.CustomerPaymentTerm;   

		If ValueIsFilled(Header.Number1)
			Then
		TemplateArea.Parameters.Number1	   = Header.Number1  ;
		EndIf;
		...
		TemplateArea.Parameters.Author  = Header.Author;  /////////////////////////////////////////////////////////   RARES   //////////////////////////////
				Query		= New Query;
		Query.Text	= 
		"SELECT
		...
		Query.SetParameter("Author", Header.Author);
		...
		While SelectionD.Next() Do
			Try
				TemplateArea.Parameters["CNPU"]	= SelectionD.Employee.Ind.PersonalCode;
				TemplateArea.Parameters["CIU"]	= SelectionD.Employee.Ind.IDCard;
			Except
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////   RARES   ////////////////////////////////
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////           ////////////////////////////////
		//TemplateArea = Template.GetArea("Total");                                                  ////////////////   Rares   ////////////////////////////////
		...
		TemplateArea.Parameters.	 TotalToPay = VATAmount + Amount;                                                                                                                                                 //
	//EndIf;                                                                                                                                                  //
		//	SpreadsheetDocument.Put(TemplateArea);                                                                                                            //
		//                                                                                                                                                      //
