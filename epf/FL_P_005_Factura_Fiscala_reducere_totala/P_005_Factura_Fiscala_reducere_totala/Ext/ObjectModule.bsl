...
Function CreatePrintForm(ObjectArray, PrintObjects, TemplateName)	
	...
	AreaInventory1		= Template.GetArea("Line1");
 	AreaInventory2		= Template.GetArea("Line2");	
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	EndIf;
		...
		TotalReducere	 = TotalReducere + ((Amount* SelectionInventory.DiscountMarkupRate)/100);
		TotalReducereTVA = TotalReducereTVA + ((VATAmount* SelectionInventory.DiscountMarkupRate)/100);
		
		SumaNeredusa= Amount +TotalReducere;
...
////////////////////////////////////////////////AreaInventoryHeader 2 Start////////////////////////////		
///////////////////////////////////////////////////////////////////////////////////////////////////////
	

		AreaInventory2.Parameters["DiscountRateMedie"]		= "Reducere"; 
		AreaInventory2.Parameters["AmountDiscountTotal"]	= "-" +Format(TotalReducere,"NFD=2");
		AreaInventory2.Parameters["VATAmountDiscountTotal"]	= "-" +Format(TotalReducereTVA,"NFD=2");
	    Spreadsheet.Put(AreaInventory2);	
	
//////////////////////////////////////////////////AreaInventoryHeader 2 End////////////////////////////		
///////////////////////////////////////////////////////////////////////////////////////////////////////	
			
	For i=i +1 To 30 Do       // Adelin Serb  08.02.2015 40->10
		...
		AreaInventory2.Parameters["DiscountRateMedie"]= Undefined;
